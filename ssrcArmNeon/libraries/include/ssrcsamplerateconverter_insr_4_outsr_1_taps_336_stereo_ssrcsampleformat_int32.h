...
*******************************************************************************/
#ifndef  SsrcSampleRateConverter_insr_4_outsr_1_taps_336_stereo_SsrcSampleFormat_int32_h
#include "ssrcSampleRateConverter.h"
class SsrcSampleRateConverter_insr_4_outsr_1_taps_336_stereo_SsrcSampleFormat_int32 :
    public SsrcSampleRateConverterTemplate<
    class SsrcSampleRateConverter_insr_4_outsr_1_taps_336_stereo_SsrcSampleFormat_int32,/* input iSample rate */
    4,/* input iSample rate */
    1,/* output iSample rate */
    336, /* num taps per oSample */
    8,/* number of taps and samples red per read cycle */
    384,/*max iSamples needed per run*/
...
public:
bool process();
SsrcSampleRateConverter_insr_4_outsr_1_taps_336_stereo_SsrcSampleFormat_int32();
};

...
*******************************************************************************/
#ifndef  SsrcSampleRateConverter_insr_2_outsr_3_taps_96_mono_SsrcSampleFormat_int32_h
#include "ssrcSampleRateConverter.h"
class SsrcSampleRateConverter_insr_2_outsr_3_taps_96_mono_SsrcSampleFormat_int32 :
    public SsrcSampleRateConverterTemplate<
    class SsrcSampleRateConverter_insr_2_outsr_3_taps_96_mono_SsrcSampleFormat_int32,/* input iSample rate */
    2,/* input iSample rate */
    3,/* output iSample rate */
    96, /* num taps per oSample */
    8,/* number of taps and samples red per read cycle */
    112,/*max iSamples needed per run*/
...
public:
bool process();
SsrcSampleRateConverter_insr_2_outsr_3_taps_96_mono_SsrcSampleFormat_int32();
};

...
*******************************************************************************/
#ifndef  SsrcSampleRateConverter_insr_1280_outsr_441_taps_320_stereo_SsrcSampleFormat_int32_h
#include "ssrcSampleRateConverter.h"
class SsrcSampleRateConverter_insr_1280_outsr_441_taps_320_stereo_SsrcSampleFormat_int32 :
    public SsrcSampleRateConverterTemplate<
    class SsrcSampleRateConverter_insr_1280_outsr_441_taps_320_stereo_SsrcSampleFormat_int32,/* input iSample rate */
    1280,/* input iSample rate */
    441,/* output iSample rate */
    320, /* num taps per oSample */
    8,/* number of taps and samples red per read cycle */
    355,/*max iSamples needed per run*/
...
public:
bool process();
SsrcSampleRateConverter_insr_1280_outsr_441_taps_320_stereo_SsrcSampleFormat_int32();
};

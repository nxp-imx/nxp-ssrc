...
*******************************************************************************/
#ifndef  SsrcSampleRateConverter_insr_1024_outsr_441_taps_136_mono_SsrcSampleFormat_int32_h
#include "ssrcSampleRateConverter.h"
class SsrcSampleRateConverter_insr_1024_outsr_441_taps_136_mono_SsrcSampleFormat_int32 :
    public SsrcSampleRateConverterTemplate<
    class SsrcSampleRateConverter_insr_1024_outsr_441_taps_136_mono_SsrcSampleFormat_int32,/* input iSample rate */
    1024,/* input iSample rate */
    441,/* output iSample rate */
    136, /* num taps per oSample */
    8,/* number of taps and samples red per read cycle */
    192,/*max iSamples needed per run*/
...
public:
bool process();
SsrcSampleRateConverter_insr_1024_outsr_441_taps_136_mono_SsrcSampleFormat_int32();
};

...
*******************************************************************************/
#ifndef  SsrcSampleRateConverter_insr_441_outsr_160_taps_232_mono_SsrcSampleFormat_int32_h
#include "ssrcSampleRateConverter.h"
class SsrcSampleRateConverter_insr_441_outsr_160_taps_232_mono_SsrcSampleFormat_int32 :
    public SsrcSampleRateConverterTemplate<
    class SsrcSampleRateConverter_insr_441_outsr_160_taps_232_mono_SsrcSampleFormat_int32,/* input iSample rate */
    441,/* input iSample rate */
    160,/* output iSample rate */
    232, /* num taps per oSample */
    8,/* number of taps and samples red per read cycle */
    299,/*max iSamples needed per run*/
...
public:
bool process();
SsrcSampleRateConverter_insr_441_outsr_160_taps_232_mono_SsrcSampleFormat_int32();
};

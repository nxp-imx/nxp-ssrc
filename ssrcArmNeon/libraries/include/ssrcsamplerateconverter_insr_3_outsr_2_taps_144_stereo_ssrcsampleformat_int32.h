...
*******************************************************************************/
#ifndef  SsrcSampleRateConverter_insr_3_outsr_2_taps_144_stereo_SsrcSampleFormat_int32_h
#include "ssrcSampleRateConverter.h"
class SsrcSampleRateConverter_insr_3_outsr_2_taps_144_stereo_SsrcSampleFormat_int32 :
    public SsrcSampleRateConverterTemplate<
    class SsrcSampleRateConverter_insr_3_outsr_2_taps_144_stereo_SsrcSampleFormat_int32,/* input iSample rate */
...
public:
bool process();
SsrcSampleRateConverter_insr_3_outsr_2_taps_144_stereo_SsrcSampleFormat_int32();
};
